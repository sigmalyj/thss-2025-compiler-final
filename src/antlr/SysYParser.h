...
public:
  ...
  enum {
    ...
    RuleLorExp = 18, RuleLandExp = 19, RuleEqExp = 20, RuleRelExp = 21, 
    RuleAddExp = 22, RuleMulExp = 23, RuleUnaryExp = 24, RulePrimaryExp = 25, 
    RuleLVal = 26, RuleNumber = 27, RuleFuncRParams = 28, RuleConstExp = 29
  };
